...
<pin name="ACC" x="-12.7" y="0" length="short"/>
<pin name="3V3" x="-12.7" y="-5.08" length="short" direction="pwr"/>
...
<connects>
<connect gate="C$1" pin="3V3" pad="3"/>
<connect gate="C$1" pin="ACC" pad="2"/>
<connect gate="C$1" pin="GND" pad="6"/>
<connect gate="C$1" pin="NC" pad="5"/>
<connect gate="C$1" pin="SCL" pad="4"/>
...
<part name="R1" library="SparkFun-Resistors" deviceset="RESISTOR" device="0603" value="430"/>
</parts>
<sheets>
<sheet>
<plain>
...
<instance part="LED1" gate="G$1" x="106.68" y="33.02" rot="R90"/>
